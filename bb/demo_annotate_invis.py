...
filename = '51020_sessie2_taskrobotEngagement'
ext = '.MP4'
file = filename + ext
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        while True:
            ...
            if len(faces) > 0:
                # Assume biggest face in scene is the child's face. This is the only face relevant
...
"""
        ...
        dataframe.to_csv('/home/linlincheng/Gaze_estimation/gaze-automated-annotation/bb/pitchjaw/' + filename + '.csv', index=False)"""
